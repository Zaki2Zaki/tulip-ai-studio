...
const pageData: Record<string, {
  ...
  "pre-production": {
    ...
    blocks: [
      { id: "storyboard", label: "AI Storyboard Automation", color: "bg-[hsl(270_40%_15%/0.6)]", hoverTitle: "Key Moments Visualization", hoverDescription: "AI-powered storyboard generation from script analysis — visualizing key narrative moments in silent-film style planning sequences.", hoverMetric: "Coming Q2 2026" },
  ...
  "post-production": {
    ...
    blocks: [
      { id: "render", label: "AI Render Polish", color: "bg-[hsl(270_40%_15%/0.6)]", hoverTitle: "ML-Powered Denoising & Upscaling", hoverDescription: "Production-quality denoising and super-resolution that cuts render times by 70% while maintaining artistic intent.", hoverMetric: "Coming Q2 2026" },
