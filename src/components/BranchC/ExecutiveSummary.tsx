...
function buildPDF(
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8">
    ...
    <footer>
      Based on published industry benchmarks. Results vary by studio size and pipeline maturity.<br>
      Sources: Griffin GP Game Development Report 2023 · Tencent Hunyuan3D Pipeline Report 2024 ·
      SP Studios Generative Environments 2024 · Third Point Ventures AI Impact on Gaming 2025<br>
