...
const CALENDLY = "https://calendly.com/youki-tuliptechlabs/30min";
...
function buildPDF(
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8">
    ...
    <div class="next-step">
      ...
      <a href="${CALENDLY}" class="calendly-link">Book Now → calendly.com/youki-tuliptechlabs/30min</a>
    </div>
...
export default function ExecutiveSummary({
  ...
  return (
    <div className="max-w-2xl" style={{ color: "white", fontSize: "14px" }}>
      ...
      <p className="text-[15px] text-white font-body mb-6">
      ...
      <div className="rounded-2xl border border-border/40 bg-card/50 overflow-hidden mb-6">
            ...
            {topRisks.map((risk) => (
              <div key={risk.id} className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <span className="text-[15px] font-body text-white">{risk.exposure}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="px-5 py-4 border-b border-border/20">
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <span className="text-[15px] font-body text-white">
        ...
        <div className="px-5 py-4">
          ...
          >
            Book Now → calendly.com/youki-tuliptechlabs/30min
          </a>
        </div>
      </div>
      ...
      {emailModalOpen && (
        ...
        >
          <div className="w-full max-w-sm rounded-2xl border border-border/40 bg-card p-6 relative">
            ...
            <p className="text-[15px] font-body text-white mb-4">
