    ...
    <section className="relative flex items-center overflow-hidden" style={{ minHeight: "95vh" }}>
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 md:px-10 lg:px-12 py-24 md:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          {/* Left: Content Block — everything grouped */}
          <motion.div
          ...
          >
            ...
            {/* CTA Group — hierarchical */}
            <div className="flex flex-col gap-3 mt-2">
              {/* Primary CTA */}
              <button
                onClick={() => setCalendlyOpen(true)}
                className="hero-btn-explore hero-btn-bloom w-full sm:w-auto px-8 py-3.5 rounded-full font-display font-semibold text-sm transition-all min-h-[44px] flex items-center justify-center gap-2"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-2.5">
                <a
                  href="#estimator"
                  className="hero-btn-quote hero-btn-bloom flex-1 px-6 py-3 rounded-full font-display font-semibold text-sm transition-all min-h-[44px] flex items-center justify-center"
                >
                  Get Estimate
                </a>
                <a
                  ...
                  className="hero-btn-assessment hero-btn-bloom flex-1 px-6 py-3 rounded-full font-display font-semibold text-sm transition-all min-h-[44px] flex items-center justify-center gap-2"
                >
          ...
          {/* Right: empty for now — reserved for future visual/particle/flower */}
