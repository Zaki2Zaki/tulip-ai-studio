...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content — aligned with navbar max-w-7xl container */}
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-2xl md:text-3xl font-display font-bold text-white/95" style={{ letterSpacing: "-0.01em" }}>
                ...
                <br />
                <span style={{ position: "relative", left: "-0.4em" }}>Systems</span>
              </p>

              {/* Description — same font-display and text-white/95 as headline */}
              <p className="text-lg md:text-xl font-display font-bold text-white/95 leading-relaxed">
                3D Workflow & Tools Experiments → GenAI Production Systems
              </p>

              <p className="text-base md:text-lg font-display font-bold text-white/95 leading-relaxed">
                ...
                <span className="text-gradient-tulip-ombre">love</span>{" "}
                handling the hard part:{" "}
                making genAI reliable for our creatives & technical leaders
              </p>

              {/* Pipeline steps — clean text flow */}
