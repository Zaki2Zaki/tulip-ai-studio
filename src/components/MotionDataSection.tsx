    ...
    <section className="relative py-32">
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto section-padding">
        ...
        <motion.p
          ...
          className="font-body text-base leading-relaxed max-w-4xl mx-auto text-center mb-6 text-white md:text-lg">
        ...
        <motion.p
          ...
          className="font-body text-sm leading-relaxed max-w-3xl mx-auto text-center mb-20 md:text-lg text-blue-50">
