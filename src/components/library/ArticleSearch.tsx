                        ...
                        <div className="flex flex-wrap gap-1.5 justify-center mt-3">
                          {["Summarize this paper", "Key findings?", "Methodology?"].map((q) => (
                            <button
                              ...
                              className="px-2 py-1 text-xs font-body rounded-md border border-border text-muted-foreground hover:text-foreground hover:border-primary/20 transition-all"
                            >
                              {q}
                            </button>
                          ))}
                  ...
                  <div className="p-3 border-t border-border">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 bg-muted/20 border border-border rounded-lg px-3 py-2 text-xs text-foreground font-body placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-accent/30"
