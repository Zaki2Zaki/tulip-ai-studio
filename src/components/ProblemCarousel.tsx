...
const challenges: Challenge[] = [
  {
    id: 'art-rework-tax',
    number: '01',
    headline: '30% Art Rework Tax',
    accentText: 'PAIN POINT',
    description: 'Slash asset iteration costs by $200K per AAA title with trained models',
    ...
    imageText: { line1: 'ART', line2: 'REWORK' },
    solution: 'Trained models reduce iteration cycles and asset rework costs',
  ...
  },
  {
    id: 'qa-failure-cost',
    number: '02',
    headline: '$50M QA Failure Cost',
    accentText: 'PAIN POINT',
    description: 'Prevent Cyberpunk-scale disasters with AI-assisted regression testing',
    citation: 'Third Point Ventures, AI Impact on Gaming and Media Tooling, 2025',
    citationUrl: 'https://www.thirdpointventures.com/currents/AI-impact-on-gaming-and-media-tooling/',
    gradientColors: { start: '#ede6f5', end: '#e0cce7' },
    imageText: { line1: 'QA', line2: 'FAILURE' },
    solution: 'AI-assisted regression testing prevents launch-day disasters',
    service: 'Studio Style Training',
    pricing: '$25K–$350K'
  },
  {
    id: 'style-consistency-llm',
    number: '03',
    ...
    imageText: { line1: 'STYLE', line2: 'CONSISTENCY' },
    solution: 'LLM training preserves studio style at scale',
    service: 'Motion Capture Integration',
    pricing: '$40K–$150K'
  },
  {
    id: 'mesh-topology-bottleneck',
    number: '04',
    headline: 'Mesh Topology Cleanup Bottleneck',
    accentText: 'PAIN POINT',
    description: 'AI generates assets but topology failures demand manual retopology hours',
    citation: 'Third Point Ventures, AI Impact on Gaming and Media Tooling, 2025',
    citationUrl: 'https://www.thirdpointventures.com/currents/AI-impact-on-gaming-and-media-tooling/',
    gradientColors: { start: '#cac1e7', end: '#b0cced' },
    imageText: { line1: 'MESH', line2: 'TOPOLOGY' },
    solution: 'Automated retopology pipelines eliminate manual cleanup hours',
    service: 'GenAI Tool Benchmarking',
    pricing: '$15K–$50K'
  },
  {
    id: 'tool-selection-paralysis',
    number: '05',
    headline: 'GenAI Tool Selection Paralysis',
    accentText: 'PAIN POINT',
    description: 'Consolidate AI stack to save $500K annually in wasted engineering time',
    citation: 'a16z Games Survey via Udonis, 2024',
    citationUrl: 'https://www.blog.udonis.co/mobile-marketing/mobile-games/ai-game-development',
    gradientColors: { start: '#b0cced', end: '#a2d5e5' },
    imageText: { line1: 'TOOL', line2: 'PARALYSIS' },
    solution: 'Benchmark and consolidate your AI stack for maximum ROI',
