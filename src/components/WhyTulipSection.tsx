    ...
    <section className="py-32 section-padding">
      <div ref={ref} className="max-w-5xl mx-auto text-center">
        ...
        <motion.p
          ...
          We're focused on <span className="font-bold" style={{ color: '#d48aff' }}>flow, adoption and integration</span> for our tools. Aiming for seamlessly into existing pipelines, delivering production-ready work via API for scalable, automated pipelines.
        </motion.p>
