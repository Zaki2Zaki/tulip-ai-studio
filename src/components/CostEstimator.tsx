      ...
      <div ref={ref}>
        ...
        >
          ...
          <button
            ...
            className="px-8 py-4 text-lg rounded-full border-0 bg-gradient-to-r from-[#F97794] via-[#F5A4C7] to-[#E5B4E2] text-white hover:opacity-90 transition-opacity inline-flex items-center gap-3"
          >
