      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "14px" }}>
            <span style={{ fontSize: "14px", fontWeight: 500, padding: "5px 14px", borderRadius: "99px", border: "0.5px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.03)", color: "rgba(255,255,255,0.4)", fontFamily: "inherit" }}>Coming soon</span>
            {["Producer", "Art or Creative Director", "Development Director", "Studio Manager"].map((r) => (
              <span key={r} style={{ fontSize: "14px", fontWeight: 500, padding: "5px 14px", borderRadius: "99px", border: "0.5px solid rgba(167,139,250,0.35)", background: "rgba(167,139,250,0.07)", fontFamily: "inherit", display: "inline-block" }}>
      ...
      <div className="mt-6 text-left" style={{ border: "0.5px solid rgba(167,139,250,0.55)", borderRadius: "10px", padding: "1.25rem 1.375rem", background: "rgba(167,139,250,0.03)", marginBottom: "1rem" }}>
        <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "14px" }}>
              <span style={{ fontSize: "14px", fontWeight: 500, padding: "5px 14px", borderRadius: "99px", border: "0.5px solid rgba(29,158,117,0.35)", background: "rgba(29,158,117,0.07)", color: "#5DCAA5", fontFamily: "inherit" }}>Live</span>
